...
const Navbar = () => {
    ...
    function scrollFunction() {
        if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
            document.getElementById("navbar").style.backgroundColor = "rgba(33, 32, 56, 0.84)";
        } else {
        ...
        <>
            <nav id='navbar'>
                <div className='nav_logo' style={{ cursor: 'pointer' }}>
                    <a className='logo_a'>
                        <img src="https://rawgit.com/gorangajic/react-icons/master/react-icons.svg" alt="" style={{ width: "80px", height: "50px" }} />
                        <span>Umudov</span>
                    </a>
                </div>
                ...
                <div ref={navRef} className='nav_container'>
                    ...
                    <div className='nav_text'>
                        <ul className='nav_elements'>
                            ...
                            <li><Link activeClass='active' smooth spy to="project">
                            ...
                            <li><Link activeClass='active' smooth spy to="contact">
